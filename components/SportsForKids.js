                ...
                <main id="main">
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                <div className="col-lg-5 d-flex align-items-center justify-content-center about-img">
                                    <img src="/images/pic6.jpg" className="img-fluid rounded-3" alt="" data-aos="zoom-in"/>
                                </div>
                    ...
                    <section id="about" className="about section-bg">
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-5 d-flex align-items-center justify-content-center about-img">
                                    <img src="/images/pic7.jpg" className="img-fluid rounded-3" alt="" data-aos="zoom-in"/>
                                </div>
                            </div>
                    ...
                    <section id="about" className="about section-bg">
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                <div className="col-lg-5 d-flex align-items-center justify-content-center about-img">
                                    <img src="/images/pic8.jpg" className="img-fluid rounded-3" alt="" data-aos="zoom-in"/>
                                </div>
                                <div className="col-lg-6 pt-5 pt-lg-0">
                    ...
                    <section id="about" className="about section-bg">
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-5 d-flex align-items-center justify-content-center about-img">
                                    <img src="/images/pic9.jpg" className="img-fluid rounded-3" alt="" data-aos="zoom-in"/>
                                </div>
                            </div>
                    ...
                    <section id="about" className="about section-bg">
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                <div className="col-lg-5 d-flex align-items-center justify-content-center about-img">
                                    <img src="/images/pic10.jpg" className="img-fluid rounded-3" alt="" data-aos="zoom-in"/>
                                </div>
                                <div className="col-lg-6 pt-5 pt-lg-0">
                    ...
                    <section id="about" className="about section-bg">
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-5 d-flex align-items-center justify-content-center about-img">
                                    <img src="/images/pic11.jpg" className="img-fluid rounded-3" alt="" data-aos="zoom-in"/>
                                </div>
                            </div>
