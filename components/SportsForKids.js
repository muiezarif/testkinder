                        ...
                        <div className="container" data-aos="fade-up">
                            <div className="row align-items-center justify-content-center">
                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="300">
                                    <div className="icon-box cursor-pointer" onClick={this.onSportsForKidsAppForHomeTrainingClick}>
                                        <p className="description">{this.props.translation("menu_app_for_hometraining")}</p>
                                    </div>
                                </div>

                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="100">
                                    <div className="icon-box cursor-pointer" onClick={this.onSportsForKidsSportsSchoolClick}>
                                        <p className="description">{this.props.translation("menu_sport_school")}</p>
                                    </div>

                                </div>
                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="100">
                                    <div className="icon-box cursor-pointer" onClick={this.onSportsForKidsSportsCoursesClick}>
                                        <p className="description">{this.props.translation("menu_sport_courses")}</p>
                                    </div>
                                ...
                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="200">
                                    <div className="icon-box cursor-pointer" onClick={this.onSportsForKidsHolidayCampsClick}>
                                        <p className="description">{this.props.translation("menu_holiday_camps")}</p>
                                    </div>
                                </div>

                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="300">
                                    <div className="icon-box cursor-pointer" onClick={this.onSportsForKidsEventsForKidsClick}>
                                        <p className="description">{this.props.translation("menu_events_for_kids")}</p>
                                    </div>
                                </div>

                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="300">
                                    <div className="icon-box cursor-pointer" onClick={this.onSportsForKidsShopForKidsClick}>
                                        <p className="description">{this.props.translation("menu_shop_for_kids")}</p>
                                    </div>
                                </div>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onSportsForKidsSportsSchoolClick}>{this.props.translation("more_text")}</a></p>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onSportsForKidsSportsCoursesClick}>{this.props.translation("more_text")}</a></p>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onSportsForKidsAppForHomeTrainingClick}>{this.props.translation("more_text")}</a></p>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onSportsForKidsShopForKidsClick}>{this.props.translation("more_text")}</a></p>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onSportsForKidsEventsForKidsClick}>{this.props.translation("more_text")}</a></p>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onSportsForKidsHolidayCampsClick}>{this.props.translation("more_text")}</a></p>
