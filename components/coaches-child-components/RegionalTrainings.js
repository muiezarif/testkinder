    ...
    render() {
        return (
            <div>
                ...
                <section id="hero" className="d-flex" style={{ backgroundImage: "url(/images/pic61.jpg)" }}>
                ...
                <section id="services" className="services bg-light-blue">
                    <div className="container" data-aos="fade-up">
                        ...
                        <div className="section-title">
                            <h3 className="text-white">{this.props.translation("coach_rt_layout_second_section_heading")}</h3>
