...
class KidsSportsClub extends Component {
    onHomeClick = () => {
        Router.push("/")
    }
    onCoachesClick = () => {
    ...
    render() {
        return (
            <div>
                ...
                {/*            <img src="/images/ksc_overview.png" className="img-fluid animated rounded-3 m-5"  alt=""/>*/}
                {/*            /!*</div>*!/*/}
                {/*        </div>*/}
                {/*    </div>*/}
                        ...
                        <div className="container" data-aos="fade-up">
                            <div className="row align-items-center justify-content-center">
                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="300">
                                    <div className="icon-box cursor-pointer" onClick={this.onKidsSportsClubsClubMemberServiceClick}>
                                        <p className="description">{this.props.translation("menu_club_member_service")}</p>
                                    </div>
                                </div>

                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="100">
                                    <div className="icon-box cursor-pointer" onClick={this.onKidsSportsClubsWebSolutionsClick}>
                                        <p className="description">{this.props.translation("menu_web_solutions")}</p>
                                    </div>

                                </div>
                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="100">
                                    <div className="icon-box cursor-pointer" onClick={this.onKidsSportsClubsTeamPackagesClick}>
                                        <p className="description">{this.props.translation("menu_team_packages")}</p>
                                    </div>
                                ...
                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="200">
                                    <div className="icon-box cursor-pointer" onClick={this.onKidsSportsClubsFirstAidCoursesClick}>
                                ...
                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="300">
                                    <div className="icon-box cursor-pointer" onClick={this.onKidsSportsClubsAppForCoachesClick}>
                                ...
                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="300">
                                    <div className="icon-box cursor-pointer" onClick={this.onKidsSportsClubsRegionalTrainingsClick}>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onKidsSportsClubsClubMemberServiceClick}>{this.props.translation("more_text")}</a></p>
                    ...
                    <section id="about" className="about section-bg">
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    <h3 data-aos="fade-up">{this.props.translation("ksc_layout_third_section_heading")}</h3>
                                    <p data-aos="fade-up" data-aos-delay="100">{this.props.translation("ksc_layout_second_section_text")}</p>
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onKidsSportsClubsRegionalTrainingsClick}>{this.props.translation("more_text")}</a></p>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100">{this.props.translation("ksc_layout_fourth_section_text")}</p>
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onKidsSportsClubsWebSolutionsClick}>{this.props.translation("more_text")}</a></p>
                    ...
                    <section id="about" className="about section-bg">
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    <h3 data-aos="fade-up">{this.props.translation("ksc_layout_fifth_section_heading")}</h3>
                                    <p data-aos="fade-up" data-aos-delay="100">{this.props.translation("ksc_layout_fifth_section_text")}</p>
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onKidsSportsClubsTeamPackagesClick}>{this.props.translation("more_text")}</a></p>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100">{this.props.translation("ksc_layout_sixth_section_text")}</p>
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onKidsSportsClubsFirstAidCoursesClick}>{this.props.translation("more_text")}</a></p>
                    ...
                    <section id="about" className="about section-bg">
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    <h3 data-aos="fade-up">{this.props.translation("ksc_layout_seventh_section_heading")}</h3>
                                    <p data-aos="fade-up" data-aos-delay="100">{this.props.translation("ksc_layout_seventh_section_text")}</p>
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onKidsSportsClubsAppForCoachesClick}>{this.props.translation("more_text")}</a></p>
