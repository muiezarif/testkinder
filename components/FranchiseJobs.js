                        ...
                        <div className="container" data-aos="fade-up">
                            <div className="row align-items-center justify-content-center">
                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="300">
                                    <div className="icon-box cursor-pointer" onClick={this.onFranchiseBecomeCoachClick}>
                                        <p className="description">{this.props.translation("menu_become_coach")}</p>
                                    </div>
                                </div>

                                <div className="col-md-6 col-lg-3 d-flex justify-content-center" data-aos="zoom-in"
                                     data-aos-delay="100">
                                    <div className="icon-box cursor-pointer" onClick={this.onFranchiseBecomeFranchiseClick}>
                                        <p className="description">{this.props.translation("menu_become_franchise")}</p>
                                    </div>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onFranchiseBecomeCoachClick}>{this.props.translation("more_text")}</a></p>
                        ...
                        <div className="container">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-lg-6 pt-5 pt-lg-0">
                                    ...
                                    <p data-aos="fade-up" data-aos-delay="100"><a className="btn-get-started scrollto cursor-pointer" onClick={this.onFranchiseBecomeFranchiseClick}>{this.props.translation("more_text")}</a></p>
